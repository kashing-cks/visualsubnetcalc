...
- **Aggregate Ranges** — turn a list of addresses and ranges from anywhere else into the
  smallest set of blocks that covers exactly those addresses, and say which entries overlap
  each other. Paste them, or load a CSV or Excel file and every cell in it is checked.
